...
// Element Class
class bkPageHeaderBlock extends WPBakeryShortCode {

    // Element Init
    function __construct() {
        add_action( 'init', array( $this, 'bk_pageheaderblock_mapping' ) );
        add_shortcode( 'bk_pageheaderblock', array( $this, 'bk_pageheaderblock_html' ) );
    }

    // Element Mapping
    public function bk_pageheaderblock_mapping() {
        ...
        vc_map(
            ...
            array(
                'name' => __('Beken Page Header', 'text-domain'),
                'base' => 'bk_pageheaderblock',
                'description' => __('A simple block for the page headers', 'text-domain'),
    ...
    // Element HTML
    public function bk_pageheaderblock_html( $atts,$content ) {
        ...
        $classes .= ' '.$text_align;
        $html = '<section class="bk-block  page-header '.$classes.'">
